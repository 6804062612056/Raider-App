...
class TrackingMap(Screen):
    ...
    PEER_TIMEOUT = 7.0  # ขยายเวลาเผื่อจังหวะมือถือหน่วงเน็ตบน Android
    ...
    def on_enter(self):
        ...
        # เปิด Multicast Lock บน Android ป้องกัน OS บล็อก UDP ในแอปเบื้องหลัง
        if platform == "android":
    ...
    def on_empty_click(self, instance):
        ...
        def _send_finish():
            try:
                ...
                # ส่งผ่าน Subnet ทั้งหมดที่ดึงได้จาก network helper
