...
class Map(Screen):
    ...
    def start_gps(self):
        ...
        # 1. ขอพิกัดจาก GPS ปกติ (แม่นยำสูงเมื่ออยู่กลางแจ้ง)[cite: 15]
        ...
        # 2. เพิ่มการขอพิกัดจาก Network Provider (ช่วยให้จับตำแหน่งได้ไวขึ้นผ่าน Wi-Fi/เสาสัญญาณมือถือในตึก)[cite: 15]
