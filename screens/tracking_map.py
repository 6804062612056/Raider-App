...
class TrackingMap(Screen):
    ...
    def add_finish_button(self):
        ...
        # 1. สร้าง Button ปรับแต่งฟอนต์ Roboto และขนาด
        self.finish_btn = Button(
            ...
            background_normal="",
            background_down="",
            background_color=(0, 0, 0, 0),  # ปิดพื้นหลังสี่เหลี่ยมเดิมของ Kivy
        )

        # 2. วาดทรงแคปซูลสีเขียวสดใส
        ...
        # 3. ฟังก์ชันอัปเดตตำแหน่ง และเปลี่ยนสีเข้มขึ้นตอนกด
        ...
        def on_btn_state_change(instance, value):
            if value == "down":
                self.finish_btn_color.rgba = (0, 0.6, 0.25, 1)  # เขียวเข้มตอนกด
            else:
                self.finish_btn_color.rgba = (0, 0.75, 0.3, 1)  # เขียวสดปกติ

        # 4. Bind Events (คงการ bind on_release เดิมไว้)
