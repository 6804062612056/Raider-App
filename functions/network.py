...
# รายการ IP ของ VPN แบบ Direct ที่กำหนด
DIRECT_VPN_IPS = [
    "10.243.74.237",
    "10.243.163.158",
    "10.243.90.15",
...
def get_broadcast_subnets() -> set[str]:
    ...
    # เพิ่ม Direct VPN IPs เข้าไปใน Target List เพื่อให้ส่งแพ็กเก็ตตรงไปยัง IP VPN ได้ทันที
    for vpn_ip in DIRECT_VPN_IPS:
        subnets.add(vpn_ip)
